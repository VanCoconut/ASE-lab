...
//	init_timer(3,0x2FAF080);							// 2s 
	init_timer(3,0x5F5E10);							// 1s 
	
	enable_timer(3);
	
	//init_timer(2,0x17D7840);								// 1sec 
	//init_timer(2,0xBEBC20);									//  0.5
	//init_timer(2,0x5F5E10);									//0.25
	init_timer(2,0x2625A0);									//0.10
	//init_timer(2,0x3D090);									//0.01
