...
Num_days_sport		DCB 3
				...
				AREA    |.text|, CODE, READWRITE ,    ALIGN=2 
...
INIT			LDR R0,=Calories_food
				LDR R10,=Calories_food
				LDR R6,=Calories_food_ordered
				LDR R7,=Calories_food_ordered
				MOV R11, #6
				MOV R12, #7
...
INIT2			LDR R0,=Calories_sport
				LDR R10,=Calories_sport
				LDR R6,=Calories_sport_ordered
				LDR R7,=Calories_sport_ordered
				MOV R11, #6
				MOV R12, #7
